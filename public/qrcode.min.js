/**
 * Standalone QRCode JS Library (Zero external dependencies)
 * Generates valid scannable QR Code matrices for Canvas and SVG rendering.
 */
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.QRCode = root.QRCode || root.QRCodeLib;
  }
}(this, function() {

  // --- QR Code Model & Matrix Encoder ---
  ...
  QRRSBlock.RS_BLOCK_TABLE = [
    ...
    [2, 98, 78], [4, 61, 31], [2, 32, 14, 4, 33, 15], [4, 39, 13, 1, 40, 14],
  ...
  QR8bitByte.prototype = {
    getLength: function() { return encodeURI(this.data).replace(/%[0-9A-F]{2}/g, "a").length; },
  ...
  return {
    toCanvas: function(canvas, text, options, callback) {
      ...
      var dark = (options.color && options.color.dark) ? options.color.dark : '#000000';
      var light = (options.color && options.color.light) ? options.color.light : '#ffffff';
      ...
      try {
        ...
        var cellSize = (width - margin * 2 * (width / 200)) / count;
        var startX = (width - cellSize * count) / 2;
        var startY = startX;
    ...
    toString: function(text, options, callback) {
      ...
      try {
        ...
        var svg = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 ' + size + ' ' + size + '" width="400" height="400">' +
